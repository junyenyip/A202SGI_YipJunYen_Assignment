...
public class mathsQuestions extends AppCompatActivity {
    ...
    private Question[] mQuestionBank = new Question[]{
            new Question(R.string.question_maths1, true),
            new Question(R.string.question_maths2, false),
            new Question(R.string.question_maths3, true),
            new Question(R.string.question_maths4, false),
            new Question(R.string.question_maths5, true),
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewProgressButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(mathsQuestions.this).create();
